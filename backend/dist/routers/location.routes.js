...
locationRouter.route('/getmicro/:city/:municipality').get((req, res) => new location_controller_1.LocationController().getMicrolocation(req, res));
...
locationRouter.route('/getmunicipalities/:city').get((req, res) => new location_controller_1.LocationController().getMunicipalities(req, res));
